...
large_dataset_path = 'D:\\Course Materials\\Big Data\\Project\\Movie Lens 20M'
small_dataset_path = 'D:\\Course Materials\\Big Data\\Project\\movies_small'
...
data = small_movies_raw_data.filter(lambda line: line != small_movies_raw_data_header).\
map(lambda line: line.split(',')). \
